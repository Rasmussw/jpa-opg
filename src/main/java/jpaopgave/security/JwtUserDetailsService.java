...
public class JwtUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        List<jpaopgave.model.User> users = userService.findUsersByUsername(username);
        ...
        if(users.size()==1) {
            ...
            //da jeg har overrited Userdetail, så kan man bygger jeg bare en ny UserDetailImpl
            //udfra den user der bliver fundet tidligere.
            return UserDetailsImpl.buildUserDetailsImpl(users.get(0));

            /* gamle måde
            //en ny user fra spring security
